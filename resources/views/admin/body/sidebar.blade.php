    ...
    <div class="sidebar-header">
      ...
      <div class="sidebar-body">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#amentie" role="button" aria-expanded="false" aria-controls="emails">
              <i class="link-icon" data-feather="mail"></i>
              <span class="link-title">Amerities</span>
              <i class="link-arrow" data-feather="chevron-down"></i>
            </a>
            <div class="collapse" id="amentie">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="{{ route('amerties.all') }}" class="nav-link">Add amerities</a>
                </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="property">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="{{ route('property.all') }}" class="nav-link">Add Property</a>
                </li>
